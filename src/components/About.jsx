        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                I design secure authentication and authorization flows using
                JWT, OAuth2, and Keycloak — deploying scalable cloud solutions
                with Docker, AWS, and Spring Cloud. My focus is on writing
                clean, maintainable, and production-ready code.
              </p>

              <p className="text-gray-300 leading-relaxed mb-12">
                I also develop modern frontend experiences with React and
                TailwindCSS, manage full-stack projects from backend logic to
                UI, and share my technical insights on Medium and GitHub to help
                the community grow.
              </p>
